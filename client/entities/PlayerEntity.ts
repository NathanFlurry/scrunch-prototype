...
export class PlayerEntity extends Entity {
    ...
    public update(dt: float) {
        ...
        if (this.moveAnimationTime != undefined) {
            ...
            const targetX = Game.shared.indexToGlobalX(this.x);
            const targetY = Game.shared.indexToGlobalY(this.y);
    ...
    public canMoveTo(x: int, y: int, checkTiming: boolean = true): boolean {
        return this.canMoveToRelative(x - this.x, y - this.y, checkTiming);
    }
